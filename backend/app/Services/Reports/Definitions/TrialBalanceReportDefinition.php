...
class TrialBalanceReportDefinition implements ReportDefinition
{
    public function reportId(): string { return 'trial-balance'; }
    ...
    public function allowedSortColumns(): array { return ['account_code', 'account_name', 'debit', 'credit']; }
    ...
    public function query(ReportContext $ctx, AuthorizedStoreScope $storeScope): Builder
    {
        ...
        $query = DB::table('journal_entry_lines')
            ...
            ->selectRaw('accounts.id as account_id, accounts.code as account_code, accounts.name as account_name, SUM(journal_entry_lines.debit) as debit, SUM(journal_entry_lines.credit) as credit')
